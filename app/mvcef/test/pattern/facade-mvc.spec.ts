...
import MVC from "@/pattern/facade/mvc";
import { Container } from "@/pattern/facade/container";
import { IProxy, Service, Proxy } from "@/pattern/proxy";
import { IMediator, Mediator } from "@/pattern/mediator";
import { ICommand, Command, Macro } from "@/pattern/command";
